...
import com.example.sonic.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.sonic.databinding.FragmentReviewBinding;
...
public class MyReviewRecyclerViewAdapter extends RecyclerView.Adapter<MyReviewRecyclerViewAdapter.ViewHolder> {
    ...
    public MyReviewRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
